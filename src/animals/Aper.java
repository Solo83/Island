...
public class Aper extends Herbivore {
    ...
    static {
        ...
        menu.put(Mouse.class, 50.0);

    }

    public Aper() {
        super(Population.APER.getPicture(), Population.APER.getWeight(), Population.APER.getSpeed(), Population.APER.getMovesForDeath(), Population.APER.getMaxPopulationOnCell());
    ...
    public void eat(Island.Cell cell) {
        ...
        if (willBeEaten.getSimpleName().equalsIgnoreCase("PLANTS")) {
            ...
            if (animalToEat != null) { // Если есть, что поесть
                ...
                Animal.setAllAnimalCount(Animal.getAllAnimalCount() - 1);
